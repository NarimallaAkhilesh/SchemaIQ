...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "group/cover inline-block relative bg-background px-2 py-2 rounded-sm text-foreground transition duration-200",
        className
      )}
    >
      <AnimatePresence>
      ...
      <motion.span
        ...
        className={cn(
          "inline-block z-20 relative group-hover/cover:text-white transition duration-200",
          className
        )}
      >
        {children}
...
export const CircleIcon = ({
  ...
  return (
    <div
      className={cn(
        `group group-hover/cover:hidden bg-background opacity-20 group-hover/cover:opacity-100 rounded-full w-2 h-2 animate-pulse pointer-events-none`,
        className
      )}
    ></div>
  );
